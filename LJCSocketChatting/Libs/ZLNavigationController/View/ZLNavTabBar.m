...
//#define TABBAR_TITLE_FONT [UIFont systemFontOfSize:13.f]
#define TABBAR_TITLE_SIZE_FONT [UIFont systemFontOfSize:13.f]
...
- (void)viewConfig
{
    ...
    CGFloat widthWithoutArrow = SCREEN_WIDTH;
...
- (NSArray *)getButtonsWidthWithTitles:(NSArray *)titles;
{
    ...
    for (NSString *title in titles)
    {
        ...
        if (titles.count>4) {
            ...
            width = [NSNumber numberWithFloat:size.width + 20.f];
        }else{
            width = [NSNumber numberWithFloat:kScreenWidth/titles.count];
        }
