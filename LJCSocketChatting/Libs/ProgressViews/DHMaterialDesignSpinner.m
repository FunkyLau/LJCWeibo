...
static NSString *HxRingStrokeAnimationKey = @"materialdesignspinner.stroke";
static NSString *HxRingRotationAnimationKey = @"materialdesignspinner.rotation";

@interface DHMaterialDesignSpinner ()
...
@implementation DHMaterialDesignSpinner
...
- (void)startAnimating {
    ...
    [self.progressLayer addAnimation:animation
                              forKey:HxRingRotationAnimationKey];
    ...
    [self.progressLayer addAnimation:animations
                              forKey:HxRingStrokeAnimationKey];
...
- (void)stopAnimating {
    ...
    [self.progressLayer removeAnimationForKey:HxRingRotationAnimationKey];
    [self.progressLayer removeAnimationForKey:HxRingStrokeAnimationKey];
    self.isAnimating = NO;
